...
if ($InitEnv) {
	if (!(Test-Path $".\.env")) {
		Write-Host "The environment file $Path does not exist. .env file will be created based on the .env-example template"		
...
Add-HostsEntry "cm.hackathon.local"
Add-HostsEntry "cd.hackathon.local"
Add-HostsEntry "id.hackathon.local"
Add-HostsEntry "www.hackathon.local"
...
if ($InitEnv) {
	...
	# ENVIRONMENT
	Set-DockerComposeEnvFileVariable "ENVIRONMENT" -Value $Environment

    # CD_HOST
    Set-EnvFileVariable "CD_HOST" -Value "cd.hackathon.local"
	
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.hackathon.local"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.hackathon.local"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.hackathon.local"
