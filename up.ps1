...
dotnet sitecore login --cm https://cm.hackathon.local/ --auth https://id.hackathon.local/ --allow-write true
if ($LASTEXITCODE -ne 0) {
...
Start-Process https://cm.hackathon.local/sitecore/
Start-Process https://www.hackathon.local/
